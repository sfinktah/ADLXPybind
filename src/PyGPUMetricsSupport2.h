// GPU Metrics Support2 Python class definition
class PyGPUMetricsSupport2 : public IADLXGPUMetricsSupport2
{
public:
    using IADLXGPUMetricsSupport2::IADLXGPUMetricsSupport2;
    ...
    // IADLXGPUMetricsSupport methods (inherited)
